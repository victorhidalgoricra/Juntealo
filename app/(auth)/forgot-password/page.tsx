  ...
  return (
    <Card className="w-full space-y-4">
      <div>
        ...
        <p className="text-sm text-slate-500">Ingresa tu correo y te enviaremos instrucciones para restablecer tu contraseña.</p>
      </div>
      ...
      >
        ...
        <Button disabled={loading} className="w-full">{loading ? 'Enviando...' : 'Enviar enlace'}</Button>
      </form>
