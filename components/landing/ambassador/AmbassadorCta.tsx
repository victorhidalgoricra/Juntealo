  ...
  return (
    <RevealOnScroll className="bg-[var(--bg)]">
      <div className="mx-auto w-full max-w-4xl px-4 py-16 text-center md:py-[72px]">
        ...
        <h2 className="mt-3 text-3xl font-bold tracking-tight text-[var(--text)] md:text-4xl">
          Hablemos de cómo puedes crecer con Juntealo
        </h2>
        <p className="mx-auto mt-3 max-w-lg text-sm leading-relaxed text-[var(--muted)] md:text-base">
        ...
        <a
          ...
          className="mt-7 inline-flex items-center gap-2 rounded-[var(--r-sm)] bg-[var(--accent)] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[var(--accent-dark)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg)]"
        >
