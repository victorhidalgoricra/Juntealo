...
const steps = [
  {
    ...
    description:
      'Invita a personas, grupos, asociaciones o comunidades que puedan organizar sus juntas digitalmente.',
  },
  {
    title: 'Activa tu comunidad',
    description:
      'Acompaña a tus referidos para que creen una cuenta y empiecen a usar Juntealo.',
  },
  {
    title: 'Obtén beneficios',
    description:
      'Recibe beneficios según la cantidad de usuarios referidos que se mantengan activos.',
  },
];
  ...
  return (
    <RevealOnScroll className="mx-auto w-full max-w-6xl px-4 py-10 md:px-6 md:py-14">
      ...
      <h2 className="mt-2 text-3xl font-bold tracking-tight text-[var(--text)]">
        Empieza a generar beneficios en 3 pasos
      </h2>
